...
// creating starting function
  ...
  // this will populate the roles portion 
  getRoles = () => {
...
// this allows you to add information into the seeds file 
  addSomething = () => {
    inquirer.prompt([
      {
        name: "add",
...
// the following will be to view data that is in each table 

// this will be to view anythign 
...
// this will be to view departemnts 
...
// the following will be to update data within the tables 

// this is to chose what to update 
...
// this is to update the role of the employee
...
// this is to update the employee manager
...
// the following will be to delete data from the tables 

// this is to choose what you will be deleteing 
...
// this will be to delete a department 
...
// this will be to delete a role from the table 
